...
{
    public interface IUnScheduledFeeDueHeaderService : IDisposable
    {
        ...
        IEnumerable<Sch_UnScheduledFeeDueHeaderViewModel> GetFeeDueHeaderListForIndex(int DocumentTypeId);

        Sch_UnScheduledFeeDueHeaderViewModel GetFeeDueHeaderForEdit(int FeeDueHeaderId);
    ...
    public class UnScheduledFeeDueHeaderService : IUnScheduledFeeDueHeaderService
    {
        ...
        public UnScheduledFeeDueHeaderService(IUnitOfWorkForService unitOfWork)
        {
        ...
        public IEnumerable<Sch_UnScheduledFeeDueHeaderViewModel> GetFeeDueHeaderListForIndex(int DocumentTypeId)
        {
            var temp = (from H in db.Sch_FeeDueHeader
                        where H.DocTypeId == DocumentTypeId
                        select new Sch_UnScheduledFeeDueHeaderViewModel
                        {
                            FeeDueHeaderId = H.FeeDueHeaderId,
                            DocNo = H.DocNo,
                            DocDate = H.DocDate,
                            LastDate = H.LastDate,
                            FeeName = H.Fee.FeeName,
                            Remark = H.Remark
                        });
        ...
        public Sch_UnScheduledFeeDueHeaderViewModel GetFeeDueHeaderForEdit(int FeeDueHeaderId)
        {
            var temp = (from H in db.Sch_FeeDueHeader

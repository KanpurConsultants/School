...
namespace Surya.India.Service
{
    public interface IProdOrderCancelHeaderService : IDisposable
    {
        ...
        IQueryable<ProdOrderCancelHeaderViewModel> GetProdOrderCancelHeaderList(int id);
    ...
    public class ProdOrderCancelHeaderService : IProdOrderCancelHeaderService
    {
        ...
        public IQueryable<ProdOrderCancelHeaderViewModel> GetProdOrderCancelHeaderList(int id)
        {

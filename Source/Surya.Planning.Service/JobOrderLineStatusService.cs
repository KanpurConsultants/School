...
namespace Surya.India.Service
{
    ...
    public class JobOrderLineStatusService : IJobOrderLineStatusService
    {
        ...
        public void UpdateJobQtyOnInvoice(int id, int InvoiceLineId, DateTime DocDate, decimal Qty,ref ApplicationDbContext Context,bool IsDbBased)
        {
        ...
        public void UpdateJobQtyOnInvoiceReceive(int id, int InvoiceLineId, DateTime DocDate, decimal Qty, ref ApplicationDbContext Context, bool IsDbBased)
        {
            int LineId = id;

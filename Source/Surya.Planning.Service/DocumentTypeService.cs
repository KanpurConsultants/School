...
namespace Surya.India.Service
{
    ...
    public class DocumentTypeService : IDocumentTypeService
    {
        ...
        {
            return _unitOfWork.Repository<DocumentType>().Find(id);
        }
        ...
        public string FGetNewDocNo(string FieldName, string TableName, int DocTypeId, DateTime DocDate, int DivisionId, int SiteId)
        {
            ...
            NewDocNoViewModel NewDocNoViewModel = db.Database.SqlQuery<NewDocNoViewModel>("" + ConfigurationManager.AppSettings["DataBaseSchema"] + ".GetNewDocNo @FieldName , @TableName ,@DocTypeId , @DocDate , @DivisionId , @SiteId ", SqlParameterFieldName, SqlParameterTableName, SqlParameterDocTypeId, SqlParameterDocDate, SqlParameterDivisionId, SqlParameterSiteId).FirstOrDefault();

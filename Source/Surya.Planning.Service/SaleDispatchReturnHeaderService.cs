...
namespace Surya.India.Service
{
    public interface ISaleDispatchReturnHeaderService : IDisposable
    {
        ...
        IQueryable<SaleDispatchReturnHeaderViewModel> GetSaleDispatchReturnPendingToApprove(int id, string Uname);
    ...
    public class SaleDispatchReturnHeaderService : ISaleDispatchReturnHeaderService
    {
        ...
        public IQueryable<SaleDispatchReturnHeaderViewModel> GetSaleDispatchReturnPendingToApprove(int id, string Uname)
        {

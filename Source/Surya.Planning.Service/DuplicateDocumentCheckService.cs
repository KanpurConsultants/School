    ...
    public class DuplicateDocumentCheckService : IDuplicateDocumentCheckService
    {
        ...
        public bool CheckForDocNoExists(string table, string docno,int doctypeId)
        {
            ...
            switch (table)
            {
                ...
                case "LedgerAccounts":
                    {
                        var temp = (from p in db.LedgerAccount
                                    where p.LedgerAccountName== docno
                                    select p).FirstOrDefault();
                        if (temp == null)
                            return false;
                        else
                ...
                case "Project":
                    {
                        var temp = (from p in db.Project
                                    where p.ProjectName == docno
                                    select p).FirstOrDefault();
                        if (temp == null)
                            return false;
                        else
        ...
        public bool CheckForDocNoExists(string table, string docno, int doctypeId,int headerid)
        {
            ...
            switch (table)
            {
                ...
                case "Size":
                    {
                        var temp = (from p in db.Size
                                    where p.SizeName== docno && p.SizeId!= headerid
                                    select p).FirstOrDefault();
                        if (temp == null)
                            return false;
                        else
                ...
                case "LedgerAccounts":
                    {
                        var temp = (from p in db.LedgerAccount
                                    where p.LedgerAccountName== docno && p.LedgerAccountId!= headerid
                                    select p).FirstOrDefault();
                        if (temp == null)
                            return false;
                        else
                ...
                case "Project":
                    {
                        var temp = (from p in db.Project
                                    where p.ProjectName == docno && p.ProjectId != headerid
                                    select p).FirstOrDefault();
                        if (temp == null)
                            return false;
                        else

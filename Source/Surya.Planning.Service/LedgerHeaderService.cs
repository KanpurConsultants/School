...
namespace Surya.India.Service
{
    public interface ILedgerHeaderService : IDisposable
    {
        ...
        IQueryable<LedgerHeaderViewModel> GetLedgerHeaderListPendingToApprove(int id, string Uname);
    ...
    public class LedgerHeaderService : ILedgerHeaderService
    {
        ...
        public IQueryable<LedgerHeaderViewModel> GetLedgerHeaderListPendingToSubmit(int id, string Uname)
        {
            ...
            List<string> UserRoles = (List<string>)System.Web.HttpContext.Current.Session["Roles"];
            var PurchaseOrderHeader = GetLedgerHeaderList(id, Uname).AsQueryable();
        ...
        public IQueryable<LedgerHeaderViewModel> GetLedgerHeaderListPendingToApprove(int id, string Uname)
        {

            List<string> UserRoles = (List<string>)System.Web.HttpContext.Current.Session["Roles"];
            var PurchaseOrderHeader = GetLedgerHeaderList(id, Uname).AsQueryable();

            var PendingToApprove = from p in PurchaseOrderHeader

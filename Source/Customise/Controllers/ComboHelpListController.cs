    ...
    public class ComboHelpListController : System.Web.Mvc.Controller
    {
        ...
        public JsonResult SetProductNature(string Ids)
          ...
          public JsonResult SetSingleMachine(int Ids)
          {
              ...
              IEnumerable<Machine> prod = from p in db.Machine
                                          where p.MachineId == Ids
                                          select p;

              ProductJson.id = prod.FirstOrDefault().MachineId.ToString();
              ProductJson.text = prod.FirstOrDefault().MachineName;
          ...
          public JsonResult SetMachine(string Ids)
          {
              ...
              for (int i = 0; i < subStr.Length; i++)
              {
                  ...
                  //IEnumerable<Product> products = db.Products.Take(3);
                  IEnumerable<Machine> prod = from p in db.Machine
                                              where p.MachineId == temp
                                              select p;
                  ProductJson.Add(new ComboBoxResult()
                  {
                      id = prod.FirstOrDefault().MachineId.ToString(),
                      text = prod.FirstOrDefault().MachineName
                  });
              }
              return Json(ProductJson);
          }
        ...
        public ActionResult GetProgram(string searchTerm, int pageSize, int pageNum)
        {
            //Get the paged results and the total count of the results for this query. ProductCacheKeyHint
            var productCacheKeyHint = "CacheProgram";

            //THis statement has been changed because GetProductHelpList was calling again and again. 

            AutoCompleteComboBoxRepositoryAndHelper ar = new AutoCompleteComboBoxRepositoryAndHelper(cbl.GetProgramHelpList(), productCacheKeyHint, RefreshData.RefreshProductData);
            //AutoCompleteComboBoxRepositoryAndHelper ar = new AutoCompleteComboBoxRepositoryAndHelper(null, productCacheKeyHint);
        ...
        public JsonResult SetProgram(string Ids)
        {
            string[] subStr = Ids.Split(',');
            List<ComboBoxResult> ProductJson = new List<ComboBoxResult>();
            for (int i = 0; i < subStr.Length; i++)
            {
                int temp = Convert.ToInt32(subStr[i]);
                //IEnumerable<Product> products = db.Products.Take(3);
                IEnumerable<Sch_Program> prod = from p in db.Sch_Program
                                                where p.ProgramId == temp
                                                select p;
                ProductJson.Add(new ComboBoxResult()
                {
                    id = prod.FirstOrDefault().ProgramId.ToString(),
                    text = prod.FirstOrDefault().ProgramName
                });
            }
            return Json(ProductJson);
        }

        public JsonResult SetSingleProgram(int Ids)
        {
            ComboBoxResult ProgramJson = new ComboBoxResult();

            IEnumerable<Sch_Program> prod = from p in db.Sch_Program
                                            where p.ProgramId == Ids
                                            select p;

            ProgramJson.id = prod.FirstOrDefault().ProgramId.ToString();
            ProgramJson.text = prod.FirstOrDefault().ProgramName;

            return Json(ProgramJson);
        }


        public ActionResult GetClass(string searchTerm, int pageSize, int pageNum)
        {
            //Get the paged results and the total count of the results for this query. ProductCacheKeyHint
            var productCacheKeyHint = "CacheClass";

            //THis statement has been changed because GetProductHelpList was calling again and again. 

            AutoCompleteComboBoxRepositoryAndHelper ar = new AutoCompleteComboBoxRepositoryAndHelper(cbl.GetClassHelpList(), productCacheKeyHint, RefreshData.RefreshProductData);
            //AutoCompleteComboBoxRepositoryAndHelper ar = new AutoCompleteComboBoxRepositoryAndHelper(null, productCacheKeyHint);
        ...
        public JsonResult SetClass(string Ids)
        {
            string[] subStr = Ids.Split(',');
            List<ComboBoxResult> ProductJson = new List<ComboBoxResult>();
            for (int i = 0; i < subStr.Length; i++)
            {
                int temp = Convert.ToInt32(subStr[i]);
                //IEnumerable<Product> products = db.Products.Take(3);
                IEnumerable<Sch_Class> prod = from p in db.Sch_Class
                                              where p.ClassId == temp
                                              select p;
                ProductJson.Add(new ComboBoxResult()
                {
                    id = prod.FirstOrDefault().ClassId.ToString(),
                    text = prod.FirstOrDefault().ClassName
                });
            }
            return Json(ProductJson);
        }
        ...
        public JsonResult SetSingleClass(int Ids)
        {
            ComboBoxResult ClassJson = new ComboBoxResult();

            IEnumerable<Sch_Class> prod = from p in db.Sch_Class
                                          where p.ClassId == Ids
                                          select p;

            ClassJson.id = prod.FirstOrDefault().ClassId.ToString();
            ClassJson.text = prod.FirstOrDefault().ClassName;
        ...
        public ActionResult GetStream(string searchTerm, int pageSize, int pageNum)
        {
            //Get the paged results and the total count of the results for this query. ProductCacheKeyHint
            var productCacheKeyHint = "CacheStream";

            //THis statement has been changed because GetProductHelpList was calling again and again. 

            AutoCompleteComboBoxRepositoryAndHelper ar = new AutoCompleteComboBoxRepositoryAndHelper(cbl.GetStreamHelpList(), productCacheKeyHint, RefreshData.RefreshProductData);
            //AutoCompleteComboBoxRepositoryAndHelper ar = new AutoCompleteComboBoxRepositoryAndHelper(null, productCacheKeyHint);
        ...
        public JsonResult SetStream(string Ids)
        {
            string[] subStr = Ids.Split(',');
            List<ComboBoxResult> ProductJson = new List<ComboBoxResult>();
            for (int i = 0; i < subStr.Length; i++)
            {
                int temp = Convert.ToInt32(subStr[i]);
                //IEnumerable<Product> products = db.Products.Take(3);
                IEnumerable<Sch_Stream> prod = from p in db.Sch_Stream
                                               where p.StreamId == temp
                                               select p;
                ProductJson.Add(new ComboBoxResult()
                {
                    id = prod.FirstOrDefault().StreamId.ToString(),
                    text = prod.FirstOrDefault().StreamName
                });
            }
            return Json(ProductJson);
        }

        public JsonResult SetSingleStream(int Ids)
        {
            ComboBoxResult StreamJson = new ComboBoxResult();

            IEnumerable<Sch_Stream> prod = from p in db.Sch_Stream
                                           where p.StreamId == Ids
                                           select p;

            StreamJson.id = prod.FirstOrDefault().StreamId.ToString();
            StreamJson.text = prod.FirstOrDefault().StreamName;
        ...
        public ActionResult GetMonths(string searchTerm, int pageSize, int pageNum)
        {
            //Get the paged results and the total count of the results for this query. ProductCacheKeyHint
            var productCacheKeyHint = "CacheMonth";

            //THis statement has been changed because GetProductHelpList was calling again and again. 

            AutoCompleteComboBoxRepositoryAndHelper ar = new AutoCompleteComboBoxRepositoryAndHelper(cbl.GetMonthHelpList(), productCacheKeyHint, RefreshData.RefreshProductData);
            //AutoCompleteComboBoxRepositoryAndHelper ar = new AutoCompleteComboBoxRepositoryAndHelper(null, productCacheKeyHint);
        ...
        public JsonResult SetMonths(string Ids)
        {
            string[] subStr = Ids.Split(',');
            List<ComboBoxResult> ProductJson = new List<ComboBoxResult>();
            for (int i = 0; i < subStr.Length; i++)
            {
                int temp = Convert.ToInt32(subStr[i]);
                //IEnumerable<Product> products = db.Products.Take(3);
                IEnumerable<Month> prod = from p in db.Month
                                          where p.MonthId == temp
                                          select p;
                ProductJson.Add(new ComboBoxResult()
                {
                    id = prod.FirstOrDefault().MonthId.ToString(),
                    text = prod.FirstOrDefault().MonthName
                });
            }
            return Json(ProductJson);
        }

        public JsonResult SetSingleMonth(int Ids)
        {
            ComboBoxResult MonthJson = new ComboBoxResult();

            IEnumerable<Month> prod = from p in db.Month
                                      where p.MonthId == Ids
                                      select p;

            MonthJson.id = prod.FirstOrDefault().MonthId.ToString();
            MonthJson.text = prod.FirstOrDefault().MonthName;

            return Json(MonthJson);
        }



        public ActionResult GetAdmissionQuota(string searchTerm, int pageSize, int pageNum)
        {
            //Get the paged results and the total count of the results for this query. ProductCacheKeyHint
            var productCacheKeyHint = "CacheAdmissionQuota";

            //THis statement has been changed because GetProductHelpList was calling again and again. 

            AutoCompleteComboBoxRepositoryAndHelper ar = new AutoCompleteComboBoxRepositoryAndHelper(cbl.GetAdmissionQuotaHelpList(), productCacheKeyHint, RefreshData.RefreshProductData);
            //AutoCompleteComboBoxRepositoryAndHelper ar = new AutoCompleteComboBoxRepositoryAndHelper(null, productCacheKeyHint);
        ...
        public JsonResult SetAdmissionQuota(string Ids)
        {
            string[] subStr = Ids.Split(',');
            List<ComboBoxResult> ProductJson = new List<ComboBoxResult>();
            for (int i = 0; i < subStr.Length; i++)
            {
                int temp = Convert.ToInt32(subStr[i]);
                //IEnumerable<Product> products = db.Products.Take(3);
                IEnumerable<Sch_AdmissionQuota> prod = from p in db.Sch_AdmissionQuota
                                                       where p.AdmissionQuotaId == temp
                                                       select p;
                ProductJson.Add(new ComboBoxResult()
                {
                    id = prod.FirstOrDefault().AdmissionQuotaId.ToString(),
                    text = prod.FirstOrDefault().AdmissionQuotaName
                });
            }
            return Json(ProductJson);
        }

        public JsonResult SetSingleAdmissionQuota(int Ids)
        {
            ComboBoxResult AdmissionQuotaJson = new ComboBoxResult();

            IEnumerable<Sch_AdmissionQuota> prod = from p in db.Sch_AdmissionQuota
                                                   where p.AdmissionQuotaId == Ids
                                                   select p;

            AdmissionQuotaJson.id = prod.FirstOrDefault().AdmissionQuotaId.ToString();
            AdmissionQuotaJson.text = prod.FirstOrDefault().AdmissionQuotaName;

            return Json(AdmissionQuotaJson);
        }
        ...
        public ActionResult GetFee(string searchTerm, int pageSize, int pageNum)
        {
            //Get the paged results and the total count of the results for this query. ProductCacheKeyHint
            var productCacheKeyHint = "CacheFee";

            //THis statement has been changed because GetProductHelpList was calling again and again. 

            AutoCompleteComboBoxRepositoryAndHelper ar = new AutoCompleteComboBoxRepositoryAndHelper(cbl.GetFeeHelpList(), productCacheKeyHint, RefreshData.RefreshProductData);
            //AutoCompleteComboBoxRepositoryAndHelper ar = new AutoCompleteComboBoxRepositoryAndHelper(null, productCacheKeyHint);
        ...
        public JsonResult SetFee(string Ids)
        {
            string[] subStr = Ids.Split(',');
            List<ComboBoxResult> ProductJson = new List<ComboBoxResult>();
            for (int i = 0; i < subStr.Length; i++)
            {
                int temp = Convert.ToInt32(subStr[i]);
                //IEnumerable<Product> products = db.Products.Take(3);
                IEnumerable<Sch_Fee> prod = from p in db.Sch_Fee
                                            where p.FeeId == temp
                                            select p;
                ProductJson.Add(new ComboBoxResult()
                {
                    id = prod.FirstOrDefault().FeeId.ToString(),
                    text = prod.FirstOrDefault().FeeName
                });
            }
            return Json(ProductJson);
        }

        public JsonResult SetSingleFee(int Ids)
        {
            ComboBoxResult FeeJson = new ComboBoxResult();

            IEnumerable<Sch_Fee> prod = from p in db.Sch_Fee
                                        where p.FeeId == Ids
                                        select p;

            FeeJson.id = prod.FirstOrDefault().FeeId.ToString();
            FeeJson.text = prod.FirstOrDefault().FeeName;
        ...
        public ActionResult GetClassSection(string searchTerm, int pageSize, int pageNum)
        {
            //Get the paged results and the total count of the results for this query. ProductCacheKeyHint
            var productCacheKeyHint = "CacheClassSection";

            //THis statement has been changed because GetProductHelpList was calling again and again. 

            AutoCompleteComboBoxRepositoryAndHelper ar = new AutoCompleteComboBoxRepositoryAndHelper(cbl.GetClassSectionHelpList(), productCacheKeyHint, RefreshData.RefreshProductData);
            //AutoCompleteComboBoxRepositoryAndHelper ar = new AutoCompleteComboBoxRepositoryAndHelper(null, productCacheKeyHint);
        ...
        public JsonResult SetClassSection(string Ids)
        {
            string[] subStr = Ids.Split(',');
            List<ComboBoxResult> ProductJson = new List<ComboBoxResult>();
            for (int i = 0; i < subStr.Length; i++)
            {
                int temp = Convert.ToInt32(subStr[i]);
                //IEnumerable<Product> products = db.Products.Take(3);
                var prod = from p in db.Sch_ClassSection
                           join C in db.Sch_Class on p.ClassId equals C.ClassId into ClassTable
                           from ClassTab in ClassTable.DefaultIfEmpty()
                           where p.ClassSectionId == temp
                           select new { ClassSectionId = p.ClassSectionId, ClassSectionName = ClassTab.ClassName + "-" + p.SectionName };
                ProductJson.Add(new ComboBoxResult()
                {
                    id = prod.FirstOrDefault().ClassSectionId.ToString(),
                    text = prod.FirstOrDefault().ClassSectionName
                });
            }
            return Json(ProductJson);
        }

        public JsonResult SetSingleClassSection(int Ids)
        {
            ComboBoxResult ClassSectionJson = new ComboBoxResult();

            var prod = from p in db.Sch_ClassSection
                       join C in db.Sch_Class on p.ClassId equals C.ClassId into ClassTable
                       from ClassTab in ClassTable.DefaultIfEmpty()
                       where p.ClassSectionId == Ids
                       select new { ClassSectionId = p.ClassSectionId, ClassSectionName = ClassTab.ClassName + "-" + p.SectionName };


            ClassSectionJson.id = prod.FirstOrDefault().ClassSectionId.ToString();
            ClassSectionJson.text = prod.FirstOrDefault().ClassSectionName;

            return Json(ClassSectionJson);
        }
        ...
        public ActionResult GetStudents(string searchTerm, int pageSize, int pageNum)
        {
            //Get the paged results and the total count of the results for this query. ProductCacheKeyHint
            var productCacheKeyHint = ConfigurationManager.AppSettings["StudentCacheKeyHint"];

            //THis statement has been changed because GetProductHelpList was calling again and again. 

            AutoCompleteComboBoxRepositoryAndHelper ar = new AutoCompleteComboBoxRepositoryAndHelper(cbl.GetStudentHelpList(), productCacheKeyHint, RefreshData.RefreshProductData);
            //AutoCompleteComboBoxRepositoryAndHelper ar = new AutoCompleteComboBoxRepositoryAndHelper(null, productCacheKeyHint);
        ...
        public JsonResult SetStudents(string Ids)
        {
            string[] subStr = Ids.Split(',');
            List<ComboBoxResult> ProductJson = new List<ComboBoxResult>();
            for (int i = 0; i < subStr.Length; i++)
        ...
        public JsonResult SetSingleStudent(int Ids)
        {
            ComboBoxResult StudentJson = new ComboBoxResult();

            PersonViewModel person = (from b in db.Sch_Student
                                      join p in db.Persons on b.PersonID equals p.PersonID into PersonTable
                                      from PersonTab in PersonTable.DefaultIfEmpty()
                                      where b.PersonID == Ids
                                      select new PersonViewModel
            ...
            StudentJson.id = person.PersonID.ToString();
            StudentJson.text = person.Name;
        ...
        public ActionResult GetAdmission(string searchTerm, int pageSize, int pageNum)
        {
            //Get the paged results and the total count of the results for this query. ProductCacheKeyHint
            var productCacheKeyHint = "CacheAdmission";

            //THis statement has been changed because GetProductHelpList was calling again and again. 

            AutoCompleteComboBoxRepositoryAndHelper ar = new AutoCompleteComboBoxRepositoryAndHelper(cbl.GetAdmissionHelpList(), productCacheKeyHint, RefreshData.RefreshProductData);
            //AutoCompleteComboBoxRepositoryAndHelper ar = new AutoCompleteComboBoxRepositoryAndHelper(null, productCacheKeyHint);
        ...
        public JsonResult SetAdmission(string Ids)
        {
            string[] subStr = Ids.Split(',');
            List<ComboBoxResult> ProductJson = new List<ComboBoxResult>();
            for (int i = 0; i < subStr.Length; i++)
            {
                ...
                var prod = from p in db.Sch_Admission
                           join s in db.Persons on p.StudentId equals s.PersonID into PersonTable
                           from PersonTab in PersonTable.DefaultIfEmpty()
                           where p.AdmissionId == temp
                           select new
                           {
                ...
                ProductJson.Add(new ComboBoxResult()
                {
                    id = prod.FirstOrDefault().AdmissionId.ToString(),
                    text = prod.FirstOrDefault().Name
                });
            }
            return Json(ProductJson);
        ...
        public JsonResult SetSingleAdmission(int Ids)
        {
            ComboBoxResult AdmissionJson = new ComboBoxResult();

            var prod = from p in db.Sch_Admission
                       join s in db.Persons on p.StudentId equals s.PersonID into PersonTable
                       from PersonTab in PersonTable.DefaultIfEmpty()
                       where p.AdmissionId == Ids
                       select new
                       {
                           AdmissionId = p.AdmissionId,
                           Name = PersonTab.Name
            ...
            AdmissionJson.id = prod.FirstOrDefault().AdmissionId.ToString();
            AdmissionJson.text = prod.FirstOrDefault().Name.ToString();

            return Json(AdmissionJson);
        }


        public ActionResult GetFacility(string searchTerm, int pageSize, int pageNum)
        {
            //Get the paged results and the total count of the results for this query. ProductCacheKeyHint
            var productCacheKeyHint = "CacheFacility";

            //THis statement has been changed because GetProductHelpList was calling again and again. 

            AutoCompleteComboBoxRepositoryAndHelper ar = new AutoCompleteComboBoxRepositoryAndHelper(cbl.GetFacilityHelpList(), productCacheKeyHint, RefreshData.RefreshProductData);
            //AutoCompleteComboBoxRepositoryAndHelper ar = new AutoCompleteComboBoxRepositoryAndHelper(null, productCacheKeyHint);
        ...
        public JsonResult SetFacility(string Ids)
        {
            string[] subStr = Ids.Split(',');
            List<ComboBoxResult> ProductJson = new List<ComboBoxResult>();
            for (int i = 0; i < subStr.Length; i++)
            {
                int temp = Convert.ToInt32(subStr[i]);
                //IEnumerable<Product> products = db.Products.Take(3);
                IEnumerable<Sch_Facility> prod = from p in db.Sch_Facility
                                                 where p.FacilityId == temp
                                                 select p;
                ProductJson.Add(new ComboBoxResult()
                {
                    id = prod.FirstOrDefault().FacilityId.ToString(),
                    text = prod.FirstOrDefault().FacilityName
                });
            }
            return Json(ProductJson);
        }

        public JsonResult SetSingleFacility(int Ids)
        {
            ComboBoxResult FacilityJson = new ComboBoxResult();

            IEnumerable<Sch_Facility> prod = from p in db.Sch_Facility
                                             where p.FacilityId == Ids
                                             select p;

            FacilityJson.id = prod.FirstOrDefault().FacilityId.ToString();
            FacilityJson.text = prod.FirstOrDefault().FacilityName;

            return Json(FacilityJson);
        }


        public ActionResult GetFacilitySubCategory(string searchTerm, int pageSize, int pageNum)
        {
            //Get the paged results and the total count of the results for this query. ProductCacheKeyHint
            var productCacheKeyHint = "CacheFacility";
            ...
            AutoCompleteComboBoxRepositoryAndHelper ar = new AutoCompleteComboBoxRepositoryAndHelper(cbl.GetFacilitySubCategoryHelpList(), productCacheKeyHint, RefreshData.RefreshProductData);
            //AutoCompleteComboBoxRepositoryAndHelper ar = new AutoCompleteComboBoxRepositoryAndHelper(null, productCacheKeyHint);
        ...
        public JsonResult SetFacilitySubCategory(string Ids)
        {
            string[] subStr = Ids.Split(',');
            List<ComboBoxResult> ProductJson = new List<ComboBoxResult>();
            for (int i = 0; i < subStr.Length; i++)
            {
                int temp = Convert.ToInt32(subStr[i]);
                //IEnumerable<Product> products = db.Products.Take(3);
                IEnumerable<Sch_FacilitySubCategory> prod = from p in db.Sch_FacilitySubCategory
                                                            where p.FacilitySubCategoryId == temp
                                                            select p;
                ProductJson.Add(new ComboBoxResult()
                {
                    id = prod.FirstOrDefault().FacilitySubCategoryId.ToString(),
                    text = prod.FirstOrDefault().FacilitySubCategoryName
                });
            }
            return Json(ProductJson);
        }

        public JsonResult SetSingleFacilitySubCategory(int Ids)
        {
            ComboBoxResult FacilitySubCategoryJson = new ComboBoxResult();

            IEnumerable<Sch_FacilitySubCategory> prod = from p in db.Sch_FacilitySubCategory
                                                        where p.FacilitySubCategoryId == Ids
                                                        select p;

            FacilitySubCategoryJson.id = prod.FirstOrDefault().FacilitySubCategoryId.ToString();
            FacilitySubCategoryJson.text = prod.FirstOrDefault().FacilitySubCategoryName;

            return Json(FacilitySubCategoryJson);
        }




        public ActionResult GetFacilityEnrollment(string searchTerm, int pageSize, int pageNum)
        {
            //Get the paged results and the total count of the results for this query. ProductCacheKeyHint
            var productCacheKeyHint = "CacheFacility";
            ...
            AutoCompleteComboBoxRepositoryAndHelper ar = new AutoCompleteComboBoxRepositoryAndHelper(cbl.GetFacilityEnrollmentHelpList(), productCacheKeyHint, RefreshData.RefreshProductData);
            //AutoCompleteComboBoxRepositoryAndHelper ar = new AutoCompleteComboBoxRepositoryAndHelper(null, productCacheKeyHint);
        ...
        public JsonResult SetFacilityEnrollment(string Ids)
        {
            string[] subStr = Ids.Split(',');
            List<ComboBoxResult> ProductJson = new List<ComboBoxResult>();
            for (int i = 0; i < subStr.Length; i++)
            {
                int temp = Convert.ToInt32(subStr[i]);
                //IEnumerable<Product> products = db.Products.Take(3);
                var prod = from p in db.Sch_FacilityEnrollment
                           where p.FacilityEnrollmentId == temp
                           select new
                           {
                               FacilityEnrollmentId = p.FacilityEnrollmentId,
                               FacilityEnrollmentName = p.FacilitySubCategory.Facility.FacilityName
                           };
                ProductJson.Add(new ComboBoxResult()
                {
                    id = prod.FirstOrDefault().FacilityEnrollmentId.ToString(),
                    text = prod.FirstOrDefault().FacilityEnrollmentName
                });
            }
            return Json(ProductJson);
        }

        public JsonResult SetSingleFacilityEnrollment(int Ids)
        {
            ComboBoxResult FacilityEnrollmentJson = new ComboBoxResult();

            var prod = from p in db.Sch_FacilityEnrollment
                       where p.FacilityEnrollmentId == Ids
                       select new
                       {
                           FacilityEnrollmentId = p.FacilityEnrollmentId,
                           FacilityEnrollmentName = p.FacilitySubCategory.Facility.FacilityName
            ...
            FacilityEnrollmentJson.id = prod.FirstOrDefault().FacilityEnrollmentId.ToString();
            FacilityEnrollmentJson.text = prod.FirstOrDefault().FacilityEnrollmentName;

            return Json(FacilityEnrollmentJson);
        }

        public ActionResult GetFeeDue(string searchTerm, int pageSize, int pageNum)
        {
            //Get the paged results and the total count of the results for this query. ProductCacheKeyHint
            var productCacheKeyHint = "CacheFeeDue";

            //THis statement has been changed because GetProductHelpList was calling again and again. 

            AutoCompleteComboBoxRepositoryAndHelper ar = new AutoCompleteComboBoxRepositoryAndHelper(cbl.GetFeeDueHelpList(), productCacheKeyHint, RefreshData.RefreshProductData);
            //AutoCompleteComboBoxRepositoryAndHelper ar = new AutoCompleteComboBoxRepositoryAndHelper(null, productCacheKeyHint);
        ...
        public JsonResult SetFeeDue(string Ids)
        {
            string[] subStr = Ids.Split(',');
            List<ComboBoxResult> ProductJson = new List<ComboBoxResult>();
            for (int i = 0; i < subStr.Length; i++)
            {
                int temp = Convert.ToInt32(subStr[i]);
                //IEnumerable<Product> products = db.Products.Take(3);
                var prod = from p in db.Sch_FeeDueLine
                           where p.FeeDueLineId == temp
                           select new
                           {
                               FeeDueLineId = p.FeeDueLineId,
                               FeeName = p.Fee.FeeName
                           };
                ProductJson.Add(new ComboBoxResult()
                {
                    id = prod.FirstOrDefault().FeeDueLineId.ToString(),
                    text = prod.FirstOrDefault().FeeName
                });
            }
            return Json(ProductJson);
        ...
        public JsonResult SetSingleFeeDue(int Ids)
        {
            ComboBoxResult FeeDueJson = new ComboBoxResult();

            var prod = from p in db.Sch_FeeDueLine
                       where p.FeeDueLineId == Ids
                       select new
                       {
                           FeeDueLineId = p.FeeDueLineId,
                           FeeName = p.Fee.FeeName
            ...
            FeeDueJson.id = prod.FirstOrDefault().FeeDueLineId.ToString();
            FeeDueJson.text = prod.FirstOrDefault().FeeName;

            return Json(FeeDueJson);
        }

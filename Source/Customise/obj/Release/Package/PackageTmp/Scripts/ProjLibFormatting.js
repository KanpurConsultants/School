...
AlertTypeConstants["Warning"] = "warn";
AlertTypeConstants["Success"] = "success";
AlertTypeConstants["Danger"] = "error";
AlertTypeConstants["Info"] = "info";



$.notify.defaults({ className: "success", position: "bottom right", clickToHide: true, autoHideDelay: 4000, });

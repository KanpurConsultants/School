...
namespace Surya.India.Core.Common
{
    ...
    {
        public const string FeeDue = "Fee Due";
        public const string UnScheduledFeeDue = "Un Scheduled Fee Due";
        public const string FeeReceive = "Fee Receive";
        public const string FeeRefund = "Fee Refund";
    ...
    public class MasterDocTypeConstants
    {
        ...
        public const string AdmissionQuota = "Admission Quota";
        public const string Facility = "Facility";
        public const string FacilitySubCategory = "Facility Sub Category";
        public const string Program = "Program";
        public const string Class = "Class";
        public const string Stream = "Stream";
        public const string ClassFee = "Class Fee";
        public const string ClassFeeLine = "Class Fee Line";
        public const string Admission = "Admission";
        public const string Student = "Student";
        public const string FacilityEnrollment = "Facility Enrollment";
        public const string FacilityStopHeader = "Facility Stop Header";
        public const string FacilityStop = "Facility Stop";
    ...
    public class DocLineTypeConstants
    {
        public const string FeeDueLine = "Fee Due Line";
        public const string UnScheduledFeeDueLine = "Un Scheduled Fee Due Line";
        public const string FeeReceiveLine = "Fee Receive Line";
        public const string FeeRefundLine = "Fee Refund Line";
    }
}
